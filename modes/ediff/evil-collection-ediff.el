...
(defun evil-collection-ediff-adjust-help ()
  ...
  (unless evil-collection-ediff-help-changed
    (dolist (msg '(ediff-long-help-message-compare2
      ...
      (dolist (chng '( ;;("^" . "  ")
                      ("p,DEL -previous diff " . "    e -previous diff ")
                      ("n,SPC -next diff     " . "    n -next diff     ")
...
(defvar evil-collection-ediff-bindings
  '(("d"    . ediff-jump-to-difference)
    ...
    ("\C-n" . evil-collection-ediff-scroll-down-1)
    ("\C-e" . evil-collection-ediff-scroll-up-1)
    ("n"    . ediff-next-difference)
    ("e"    . ediff-previous-difference)
    ...
    ("\C-z" . ediff-suspend)
    ("z"    . nil)
    ("zi"   . evil-collection-ediff-scroll-right)
    ("zk"   . evil-collection-ediff-scroll-left)
    ;; Not working yet
